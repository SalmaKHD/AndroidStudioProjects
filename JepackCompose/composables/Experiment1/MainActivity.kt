    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ComposeCourseYouTubeTheme {
                ...
                val description = "A selfie in nature"
...
fun ImageCard(
    ...
    Card (
        ...
        // when stacking composables on top of each other is needed, this can come in handy
        Box(
            ...
            Box(
                modifier = Modifier
                    .fillMaxSize()
                    .padding(12.dp),
                // the alignment is relative to the entire box
